...
class TestKauppa(unittest.TestCase):
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla_kun_kaksi_samaa_tuotetta(self):
        ...
        pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345", ANY, 6)
    ...
    def test_metodi_aloita_asiointi_nollaa_edellisen_ostoksen(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        kauppa.tilimaksu("takanaka", "1976")

        pankki_mock.tilisiirto.assert_called_with("takanaka", ANY, "1976", ANY, 1)

    def test_uusi_viitenumero_pyydetään_jokaiselle_maksutapahtumalle(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
